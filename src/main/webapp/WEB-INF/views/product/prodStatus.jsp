					...
					<c:forEach var="psdto" items="${psList }" varStatus="status">
						<tr>
							...
							판매완료
								...
								<td id="td_st" class="td_title_st" align="center" style="cursor: pointer;"
									...
									<span style="color: #551A8B; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; width: 150px; display: block;">
										${psdto.prodTitle }
									</span>
								</td>
							...
							<td id="td_st">${pickTotal[status.index] }</td>
								<c:if test="${loginUser != 'admin' }">
									<td id="td_st">
										<div class="td_btn_st">
											<button onclick="location.href='${contextPath}/product/prodUpdateForm?prodId=${psdto.prodId}'"
