...
<input type="text" readonly style="display: none;" id="place" 
   ...
   <form id="fo" action="${contextPath }/product/prodUpdate" method="post">
        ...
        <div class="flex">
           <div class="size_150">
            ...
            <div>
                 <div>
                  ...
                  name="trdLocation" placeholder="도로명주소, 지번주소"><br>
               </div>
            </div>
         </div>
         <hr>
         ...
         <div class="flex">
            ...
            <textarea id="prodContent" maxlength="500" style="resize: none;"
               rows="8" cols="100" placeholder="상품 설명을 상세히 작성해주세요.(10자 이상)"
               name="prodContent">${prod.prodContent }</textarea>
